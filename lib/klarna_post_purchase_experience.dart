...
import 'package:gv_klarna_inapp_sdk/klarna_post_purchase_environment.dart';
import 'package:gv_klarna_inapp_sdk/klarna_result.dart';
...
class KlarnaPostPurchaseExperience {
  ...
  Future<KlarnaResult> initialize(String locale, String purchaseCountry,
    ...
    final String result =
      ...
      'design': design,
      'sdkSource': environment == null ? null : KlarnaPostPurchaseEnvironmentHelper.getSdkSource(environment)
    });
